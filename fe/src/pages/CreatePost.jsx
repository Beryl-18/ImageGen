...
const CreatePost = () => {
  ...
  const generateImage = async() => {
    if (form.prompt){
      ...
      try {
        ...
        setTimeout(() => {setGeneratingImg(false)}, 5500 );
      }
    }
    else {
  ...
  const handleSubmit = async(e) => {
    ...
    if (form.prompt && form.photo){
      ...
      console.log("Form Stringified : "+ JSON.stringify(form));
      ...
      alert("Please enter your name and prompt to generate an image ")
    }
  }
  ...
  return (
    <section className="max-w-7xl mx-auto" >
      ...
      <form className="mt-16 max-w-3xl " onSubmit={handleSubmit}>
        ...
        <div className="mt-5 flex gap-5">
          <p className="mt-2 text-[#666e75] text-[16px] max-w-[500px]">
           {generatingImg && 'Please wait for the image to be retrieved. This takes about 15-20 seconds due to high server load.'}
          </p>
        </div>
